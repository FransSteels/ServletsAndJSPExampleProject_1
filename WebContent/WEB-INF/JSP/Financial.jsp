...
<body>
	...
	<div class="main">
		...
		<form
			action="<c:if test="${x==0}">FinancialServlet</c:if><c:if test="${x==1}">FinancialServletDelete</c:if><c:if test="${x==2}">FinancialServletUser</c:if><c:if test="${x==3}">FinancialServletDelUser</c:if>"
			method="get">
